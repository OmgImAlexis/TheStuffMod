...
public class EntityMouse extends EntityAnimal {
	...
	public boolean isBreedingItem(ItemStack p_70877_1_) {
		// return (p_70877_1_.getItem() == Item.getItemFromBlock(Blocks.pumpkin) ||
		// p_70877_1_.getItem() == ModItems.lettuce || p_70877_1_.getItem() == ModItems.tomato);
		return false;
	}
	...
	public void onEntityUpdate() {
		...
		/**
		 * int[] blockPos = UtilityCheck.getNearestBlockOfType(worldObj, BlockCrops.class, (int)
		 * posX, (int) posY, (int) posZ, 1);
		 * if(blockPos != null) {
		 * LogHelper.info("X: "+blockPos[0]+" Y:"+blockPos[1]+" Z:"+blockPos[2]);
		 * worldObj.getBlock(blockPos[0], blockPos[1], blockPos[2]).removedByPlayer(worldObj, null,
		 * blockPos[0], blockPos[1], blockPos[2], true);
		 * worldObj.playSoundAtEntity(this, "random.eat", 0.5F + 0.5F * (float)this.rand.nextInt(2),
