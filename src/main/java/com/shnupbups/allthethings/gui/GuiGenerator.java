...
public class GuiGenerator extends GuiContainer {
	private static final ResourceLocation furnaceGuiTextures=new ResourceLocation(Reference.MOD_ID+":textures/gui/generator.png");
	private TileEntityGenerator tileentity;

	public GuiGenerator(InventoryPlayer invPlayer,TileEntityGenerator tile) {
		super(new ContainerGenerator(invPlayer.player,tile.getWorldObj(),tile.xCoord,tile.yCoord,tile.zCoord));
	...
	protected void drawGuiContainerForegroundLayer(int x,int y) {
		...
		this.fontRendererObj.drawString(I18n.format("container.inventory",new Object[0]),this.xSize-(this.fontRendererObj.getStringWidth(I18n.format("container.inventory",new Object[0])))-10,this.ySize-94,4210752);
		drawEnergyLevel(x,y);
	}
