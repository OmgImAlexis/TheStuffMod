...
public class UstherSkyRenderer extends IRenderHandler{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
	  ...
	  f10 = 8.0F; // Size of sun from center
	  mc.renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID + ":textures/misc/sun.png")); // Sun texture + texture path
	  ...
	  f10 = 35.0F; // Size of moon from center
	  mc.renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID + ":textures/misc/moon.png")); // Moon texture + texture path
