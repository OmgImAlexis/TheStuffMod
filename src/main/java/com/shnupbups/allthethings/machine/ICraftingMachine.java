...
public interface ICraftingMachine {
	...
	public void operate();
	/**
	 * Check if a crafting operation can occur. If it returns true, run {@link #operate()}
	 * after {@link #getTimeNeeded()} ticks.
	 * 
	 ...
	 * Should be checked against stored RF in {@link #canOperate()}.
	 * <br><br>
