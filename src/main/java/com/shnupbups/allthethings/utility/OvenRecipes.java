...
public class OvenRecipes {
    ...
    public OvenRecipeShaped addRecipe(ItemStack p_92103_1_, ItemStack secondOutput, int secondChance, int rf, int craftTime, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        OvenRecipeShaped OvenRecipeShaped = new OvenRecipeShaped(j, k, aitemstack, p_92103_1_, craftTime, rf, secondOutput, secondChance);
        this.recipes.add(OvenRecipeShaped);
        return OvenRecipeShaped;
    }

    public void addShapelessRecipe(ItemStack p_77596_1_, ItemStack secondOutput, int secondChance, int craftTime, int rf, Object ... p_77596_2_)
    {
        ArrayList arraylist = new ArrayList();
        Object[] aobject = p_77596_2_;
        int i = p_77596_2_.length;
        ...
        this.recipes.add(new OvenRecipeShapeless(p_77596_1_, arraylist, secondOutput, secondChance, craftTime, rf));
    }
