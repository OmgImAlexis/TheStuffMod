...
public class Register {
	 ...
	 */
	/**
	 * public static void addMaterial(String itemname, String blockname, String orename, int
	 * blockhard, int blocklevel, Material blockmaterial, int orehard, int orelevel, Material
	 * orematerial, boolean oredropitem) {
	 * item = new ItemBasic(itemname,TMCreativeTabs.item);
	 * block = new BlockBasic(blockname, blockmaterial, TMCreativeTabs.block, blocklevel,
	 * blockhard);
	 ...
	 * GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(block), true, new Object[]{"xxx",
	 * "xxx", "xxx", Character.valueOf('x'), itemname}));
