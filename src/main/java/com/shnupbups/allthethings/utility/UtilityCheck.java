...
public class UtilityCheck {
	...
	public static boolean isItemImpureGem(Item item) {
		if(item==Items.diamond||item==Items.emerald||item==Items.quartz) {
			...
			return(item instanceof ItemMaterial&&((ItemMaterial)item).getType()==MaterialType.GEM);
		}
	}
	...
	public static int getColourForMeta(int meta) {
		switch(meta) {
			case 0:
				return ItemDye.field_150922_c[15];
			case 1:
				return ItemDye.field_150922_c[14];
			case 2:
				return ItemDye.field_150922_c[13];
			case 3:
				return ItemDye.field_150922_c[12];
			case 4:
				return ItemDye.field_150922_c[11];
			case 5:
				return ItemDye.field_150922_c[10];
			case 6:
				return ItemDye.field_150922_c[9];
			case 7:
				return ItemDye.field_150922_c[8];
			case 8:
				return ItemDye.field_150922_c[7];
			case 9:
				return ItemDye.field_150922_c[6];
			case 10:
				return ItemDye.field_150922_c[5];
			case 11:
				return ItemDye.field_150922_c[4];
			case 12:
				return ItemDye.field_150922_c[3];
			case 13:
				return ItemDye.field_150922_c[2];
			case 14:
				return ItemDye.field_150922_c[1];
			case 15:
				return ItemDye.field_150922_c[0];
			default:
				return ItemDye.field_150922_c[new Random().nextInt(15)];
		}
	}
