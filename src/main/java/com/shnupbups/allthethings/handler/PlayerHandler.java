...
public class PlayerHandler {
	...
	public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
		 ...
		 * book.setTagInfo("title", new
		 * NBTTagString(StatCollector.translateToLocal("book.allthethings:guidebook.title")));
		 * NBTTagList pages = new NBTTagList();
		 * pages.appendTag(new
		 * NBTTagString(StatCollector.translateToLocal("book.allthethings:guidebook.page1")));
		 * pages.appendTag(new
		 * NBTTagString(StatCollector.translateToLocal("book.allthethings:guidebook.page2")));
		 * pages.appendTag(new
		 * NBTTagString(StatCollector.translateToLocal("book.allthethings:guidebook.page3")));
		 * pages.appendTag(new
		 * NBTTagString(StatCollector.translateToLocal("book.allthethings:guidebook.page4")));
	...
	public void onEntityJoinWorld(EntityJoinWorldEvent event) {
		if(!event.entity.worldObj.isRemote&&event.entity instanceof EntityPlayer) {
			...
			// Nutricraft.packetPipeline.sendTo(new NCSyncPlayerPropPacket((EntityPlayer)
			// event.entity), (EntityPlayerMP) event.entity);
		}
	}
}
