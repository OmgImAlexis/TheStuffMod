...
public class ModelFox extends ModelBase {
	...
	public void render(Entity p_78088_1_,float p_78088_2_,float p_78088_3_,float p_78088_4_,float p_78088_5_,float p_78088_6_,float p_78088_7_) {
		...
		if(this.isChild) {
			...
			GL11.glTranslatef(0.02F,10.0F*p_78088_7_,3.0F*p_78088_7_);
			this.wolfHeadMain.renderWithRotation(p_78088_7_);
			GL11.glPopMatrix();
			GL11.glPushMatrix();
			GL11.glScalef((1.0F/1.2F)/f6,(1.0F/1.2F)/f6,(1.0F/1.2F)/f6);
			GL11.glTranslatef(0.0F,34F*p_78088_7_,0.0F);
			...
			GL11.glPushMatrix();
			GL11.glTranslatef(0.01F,p_78088_7_,1.0F*p_78088_7_);
			this.wolfHeadMain.renderWithRotation(p_78088_7_);
			GL11.glPopMatrix();
			GL11.glPushMatrix();
			GL11.glScalef(1.0F/1.2F,1.0F/1.2F,1.0F/1.2F);
			GL11.glTranslatef(0.0F,4.0F*p_78088_7_,0.0F);
			this.wolfBody.render(p_78088_7_);
			this.wolfLeg1.render(p_78088_7_);
			this.wolfLeg2.render(p_78088_7_);
			this.wolfLeg3.render(p_78088_7_);
	 ...
	 * and legs, where par1 represents the time(so that arms and legs swing back and forth) and par2
	 * represents how
	...
	public void setRotationAngles(float p_78087_1_,float p_78087_2_,float p_78087_3_,float p_78087_4_,float p_78087_5_,float p_78087_6_,Entity entity) {
		...
		if(this.wolfTail.rotateAngleX>=0.3F) {
			j=-1;
		} else if(this.wolfTail.rotateAngleX<=0F) {
			j=1;
		}
		this.wolfTail.rotateAngleX=((EntityFox)entity).getTailRotation();
	}
}
