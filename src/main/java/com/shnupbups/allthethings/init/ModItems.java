...
public class ModItems {
	...
	// Dusts
	public static final ItemMaterial dustAdamanite = new ItemMaterial("dustAdamanite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xAE6082);
	public static final ItemMaterial dustAdamant = new ItemMaterial("dustAdamant",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xFFAE9C);
	public static final ItemMaterial dustAluminium = new ItemMaterial("dustAluminium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xA4A8AB);
	public static final ItemMaterial dustBlurite = new ItemMaterial("dustBlurite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x64868E);
	public static final ItemMaterial dustBrass = new ItemMaterial("dustBrass",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x9A822C);
	public static final ItemMaterial dustBronze = new ItemMaterial("dustBronze",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xA56600);
	public static final ItemMaterial dustChromium = new ItemMaterial("dustChromium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xFCFCFC);
	public static final ItemMaterial dustCobalt = new ItemMaterial("dustCobalt",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x364664);
	public static final ItemMaterial dustCopper = new ItemMaterial("dustCopper",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.EVERYWHERE, 0xAA6011);
	public static final ItemMaterial dustDaeyalt = new ItemMaterial("dustDaeyalt",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xCDB6CD);
	public static final ItemMaterial dustElectrum = new ItemMaterial("dustElectrum",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xE1D45C);
	public static final ItemMaterial dustGold = new ItemMaterial("dustGold",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xFCEE4B);
	public static final ItemMaterial dustGoloid = new ItemMaterial("dustGoloid",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xF7CF1E);
	public static final ItemMaterial dustInvar = new ItemMaterial("dustInvar",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x88877C);
	public static final ItemMaterial dustIron = new ItemMaterial("dustIron",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.EVERYWHERE, 0xE2C0AA);
	public static final ItemMaterial dustLead = new ItemMaterial("dustLead",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x353047);
	public static final ItemMaterial dustLunar = new ItemMaterial("dustLunar",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xDBEADB);
	public static final ItemMaterial dustMalagnite = new ItemMaterial("dustMalagnite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.RARE, 0x762DC9);
	public static final ItemMaterial dustManganese = new ItemMaterial("dustManganese",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xB1A7A9);
	public static final ItemMaterial dustMithril = new ItemMaterial("dustMithril",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xCAD7D8);
	public static final ItemMaterial dustNickel = new ItemMaterial("dustNickel",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x6F7671);
	public static final ItemMaterial dustPlatinum = new ItemMaterial("dustPlatinum",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xCCCBC0);
	public static final ItemMaterial dustRhodium = new ItemMaterial("dustRhodium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xDFDFDF);
	public static final ItemMaterial dustRubium = new ItemMaterial("dustRubium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xCC6363);
	public static final ItemMaterial dustRunite = new ItemMaterial("dustRunite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xABBAC3);
	public static final ItemMaterial dustSilicon = new ItemMaterial("dustSilicon", ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xC6C6C6);
	public static final ItemMaterial dustSilver = new ItemMaterial("dustSilver",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xFFFFFF);
	public static final ItemMaterial dustSolder = new ItemMaterial("dustSolder",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xD2CFD6);
	public static final ItemMaterial dustSteel = new ItemMaterial("dustSteel",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x8C8C8C);
	public static final ItemMaterial dustTin = new ItemMaterial("dustTin",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xD3C9CB);
	public static final ItemMaterial dustTitanium = new ItemMaterial("dustTitanium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xA9A9A9);
	public static final ItemMaterial dustTungsten = new ItemMaterial("dustTungsten",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x686C73);
	public static final ItemMaterial dustZinc = new ItemMaterial("dustZinc",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x88887F);
	
	public static final ItemMaterial dustAmazonite = new ItemMaterial("dustAmazonite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x008F61);
	public static final ItemMaterial dustAmber = new ItemMaterial("dustAmber",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xDC8C1F);
	public static final ItemMaterial dustAmethyst = new ItemMaterial("dustAmethyst",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xCC17DD);
	public static final ItemMaterial dustAquamarine = new ItemMaterial("dustAquamarine",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x81E8DC);
	public static final ItemMaterial dustCarnelian = new ItemMaterial("dustCarnelian",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xE36543);
	public static final ItemMaterial dustCitrine = new ItemMaterial("dustCitrine",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.SUPERRARE, 0xDDD917);
	public static final ItemMaterial dustDiamond = new ItemMaterial("dustDiamond",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.RARE, 0x5DECF5);
	public static final ItemMaterial dustEmerald = new ItemMaterial("dustEmerald",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x17DD62);
	public static final ItemMaterial dustGarnet = new ItemMaterial("dustGarnet",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x942400);
	public static final ItemMaterial dustJade = new ItemMaterial("dustJade",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xDD17C0);
	public static final ItemMaterial dustKunzite = new ItemMaterial("dustKunzite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xEC9FA0);
	public static final ItemMaterial dustNetherQuartz = new ItemMaterial("dustNetherQuartz",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xDDCBBE, MaterialDimension.NETHER);
	public static final ItemMaterial dustOnyx = new ItemMaterial("dustOnyx",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.SUPERRARE, 0x3D3D3D);
	public static final ItemMaterial dustOpal = new ItemMaterial("dustOpal",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xBEC4BA);
	public static final ItemMaterial dustQuartz = new ItemMaterial("dustQuartz",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xB7B0AA);
	public static final ItemMaterial dustRuby = new ItemMaterial("dustRuby",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0xDD2317);
	public static final ItemMaterial dustSapphire = new ItemMaterial("dustSapphire",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x1740DD);
	public static final ItemMaterial dustTopaz = new ItemMaterial("dustTopaz",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xD97700);
	
	public static final ItemMaterial dustVoidium = new ItemMaterial("dustVoidium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x0F0F0F, MaterialDimension.END);
	public static final ItemMaterial dustFyrestone = new ItemMaterial("dustFyrestone",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.COMMON, 0xCC7A00, MaterialDimension.NETHER);
	
	public static final ItemMaterial dustIridium = new ItemMaterial("dustIridium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.RARE, 0xDDDDDD);
	public static final ItemMaterial dustPlutonium = new ItemMaterial("dustPlutonium", ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.RARE, 0xB1AA94);
	public static final ItemMaterial dustUranium = new ItemMaterial("dustUranium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x18BF12);
	
	public static final ItemMaterial dustCrymeretye = new ItemMaterial("dustCrymeretye",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0xFF81A8, MaterialDimension.USTHER);
	public static final ItemMaterial dustGraeconthylynium  = new ItemMaterial("dustGraeconthylynium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.COMMON, 0x454C7D, MaterialDimension.USTHER);
	public static final ItemMaterial dustMuktaphlyte  = new ItemMaterial("dustMuktaphlyte",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x943547, MaterialDimension.USTHER);
	public static final ItemMaterial dustJonjronyphyll  = new ItemMaterial("dustJonjronyphyll",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x807409, MaterialDimension.USTHER);
	public static final ItemMaterial dustKraktachnar  = new ItemMaterial("dustKraktachnar",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x005655, MaterialDimension.USTHER);
	public static final ItemMaterial dustSchulbradethenairdivite  = new ItemMaterial("dustSchulbradethenairdivite",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.COMMON, 0xC37546, MaterialDimension.USTHER);
	public static final ItemMaterial dustXaldriodythidyte  = new ItemMaterial("dustXaldriodythidyte",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x6F0037, MaterialDimension.USTHER);
	
	public static final ItemMaterial dustTrytementium = new ItemMaterial("dustTrytementium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.AVERAGE, 0x67AF00, MaterialDimension.NETHER);
	public static final ItemMaterial dustUnobtanium = new ItemMaterial("dustUnobtanium",ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.ULTRARARE, 0xF17E4A, MaterialDimension.NONE);
	
	public static final ItemMaterial dustCoal = new ItemMaterial("dustCoal", ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.EVERYWHERE, 0x373737);
	public static final ItemMaterial dustLapis = new ItemMaterial("dustLapis", ModCreativeTabs.plate, MaterialType.DUST, MaterialRarity.UNCOMMON, 0x183DC0);
	
	// Clusters
	public static final ItemMaterial clusterAdamanite = new ItemMaterial("clusterAdamanite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xAE6082);
	public static final ItemMaterial clusterAdamant = new ItemMaterial("clusterAdamant",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xFFAE9C);
	public static final ItemMaterial clusterAluminium = new ItemMaterial("clusterAluminium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xA4A8AB);
	public static final ItemMaterial clusterBlurite = new ItemMaterial("clusterBlurite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x64868E);
	public static final ItemMaterial clusterBrass = new ItemMaterial("clusterBrass",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x9A822C);
	public static final ItemMaterial clusterBronze = new ItemMaterial("clusterBronze",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xA56600);
	public static final ItemMaterial clusterChromium = new ItemMaterial("clusterChromium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xFCFCFC);
	public static final ItemMaterial clusterCobalt = new ItemMaterial("clusterCobalt",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x364664);
	public static final ItemMaterial clusterCopper = new ItemMaterial("clusterCopper",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.EVERYWHERE, 0xAA6011);
	public static final ItemMaterial clusterDaeyalt = new ItemMaterial("clusterDaeyalt",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xCDB6CD);
	public static final ItemMaterial clusterElectrum = new ItemMaterial("clusterElectrum",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xE1D45C);
	public static final ItemMaterial clusterGold = new ItemMaterial("clusterGold",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xFCEE4B);
	public static final ItemMaterial clusterGoloid = new ItemMaterial("clusterGoloid",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xF7CF1E);
	public static final ItemMaterial clusterInvar = new ItemMaterial("clusterInvar",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x88877C);
	public static final ItemMaterial clusterIron = new ItemMaterial("clusterIron",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.EVERYWHERE, 0xE2C0AA);
	public static final ItemMaterial clusterLead = new ItemMaterial("clusterLead",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x353047);
	public static final ItemMaterial clusterLunar = new ItemMaterial("clusterLunar",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xDBEADB);
	public static final ItemMaterial clusterMalagnite = new ItemMaterial("clusterMalagnite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.RARE, 0x762DC9);
	public static final ItemMaterial clusterManganese = new ItemMaterial("clusterManganese",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xB1A7A9);
	public static final ItemMaterial clusterMithril = new ItemMaterial("clusterMithril",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xCAD7D8);
	public static final ItemMaterial clusterNickel = new ItemMaterial("clusterNickel",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x6F7671);
	public static final ItemMaterial clusterPlatinum = new ItemMaterial("clusterPlatinum",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xCCCBC0);
	public static final ItemMaterial clusterRhodium = new ItemMaterial("clusterRhodium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xDFDFDF);
	public static final ItemMaterial clusterRubium = new ItemMaterial("clusterRubium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xCC6363);
	public static final ItemMaterial clusterRunite = new ItemMaterial("clusterRunite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xABBAC3);
	public static final ItemMaterial clusterSilicon = new ItemMaterial("clusterSilicon", ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xC6C6C6);
	public static final ItemMaterial clusterSilver = new ItemMaterial("clusterSilver",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xFFFFFF);
	public static final ItemMaterial clusterSolder = new ItemMaterial("clusterSolder",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xD2CFD6);
	public static final ItemMaterial clusterSteel = new ItemMaterial("clusterSteel",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x8C8C8C);
	public static final ItemMaterial clusterTin = new ItemMaterial("clusterTin",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xD3C9CB);
	public static final ItemMaterial clusterTitanium = new ItemMaterial("clusterTitanium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xA9A9A9);
	public static final ItemMaterial clusterTungsten = new ItemMaterial("clusterTungsten",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x686C73);
	public static final ItemMaterial clusterZinc = new ItemMaterial("clusterZinc",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x88887F);
	
	public static final ItemMaterial clusterAmazonite = new ItemMaterial("clusterAmazonite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x008F61);
	public static final ItemMaterial clusterAmber = new ItemMaterial("clusterAmber",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xDC8C1F);
	public static final ItemMaterial clusterAmethyst = new ItemMaterial("clusterAmethyst",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xCC17DD);
	public static final ItemMaterial clusterAquamarine = new ItemMaterial("clusterAquamarine",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x81E8DC);
	public static final ItemMaterial clusterCarnelian = new ItemMaterial("clusterCarnelian",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xE36543);
	public static final ItemMaterial clusterCitrine = new ItemMaterial("clusterCitrine",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.SUPERRARE, 0xDDD917);
	public static final ItemMaterial clusterDiamond = new ItemMaterial("clusterDiamond",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.RARE, 0x5DECF5);
	public static final ItemMaterial clusterEmerald = new ItemMaterial("clusterEmerald",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x17DD62);
	public static final ItemMaterial clusterGarnet = new ItemMaterial("clusterGarnet",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x942400);
	public static final ItemMaterial clusterJade = new ItemMaterial("clusterJade",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xDD17C0);
	public static final ItemMaterial clusterKunzite = new ItemMaterial("clusterKunzite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xEC9FA0);
	public static final ItemMaterial clusterNetherQuartz = new ItemMaterial("clusterNetherQuartz",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xDDCBBE, MaterialDimension.NETHER);
	public static final ItemMaterial clusterOnyx = new ItemMaterial("clusterOnyx",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.SUPERRARE, 0x3D3D3D);
	public static final ItemMaterial clusterOpal = new ItemMaterial("clusterOpal",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xBEC4BA);
	public static final ItemMaterial clusterQuartz = new ItemMaterial("clusterQuartz",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xB7B0AA);
	public static final ItemMaterial clusterRuby = new ItemMaterial("clusterRuby",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0xDD2317);
	public static final ItemMaterial clusterSapphire = new ItemMaterial("clusterSapphire",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x1740DD);
	public static final ItemMaterial clusterTopaz = new ItemMaterial("clusterTopaz",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xD97700);
	
	public static final ItemMaterial clusterVoidium = new ItemMaterial("clusterVoidium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x0F0F0F, MaterialDimension.END);
	public static final ItemMaterial clusterFyrestone = new ItemMaterial("clusterFyrestone",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.COMMON, 0xCC7A00, MaterialDimension.NETHER);
	
	public static final ItemMaterial clusterIridium = new ItemMaterial("clusterIridium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.RARE, 0xDDDDDD);
	public static final ItemMaterial clusterPlutonium = new ItemMaterial("clusterPlutonium", ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.RARE, 0xB1AA94);
	public static final ItemMaterial clusterUranium = new ItemMaterial("clusterUranium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x18BF12);
	
	public static final ItemMaterial clusterCrymeretye = new ItemMaterial("clusterCrymeretye",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0xFF81A8, MaterialDimension.USTHER);
	public static final ItemMaterial clusterGraeconthylynium = new ItemMaterial("clusterGraeconthylynium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.COMMON, 0x454C7D, MaterialDimension.USTHER);
	public static final ItemMaterial clusterMuktaphlyte = new ItemMaterial("clusterMuktaphlyte",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x943547, MaterialDimension.USTHER);
	public static final ItemMaterial clusterJonjronyphyll = new ItemMaterial("clusterJonjronyphyll",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x807409, MaterialDimension.USTHER);
	public static final ItemMaterial clusterKraktachnar = new ItemMaterial("clusterKraktachnar",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x005655, MaterialDimension.USTHER);
	public static final ItemMaterial clusterSchulbradethenairdivite = new ItemMaterial("clusterSchulbradethenairdivite",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.COMMON, 0xC37546, MaterialDimension.USTHER);
	public static final ItemMaterial clusterXaldriodythidyte = new ItemMaterial("clusterXaldriodythidyte",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x6F0037, MaterialDimension.USTHER);
	
	public static final ItemMaterial clusterTrytementium = new ItemMaterial("clusterTrytementium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.AVERAGE, 0x67AF00, MaterialDimension.NETHER);
	public static final ItemMaterial clusterUnobtanium = new ItemMaterial("clusterUnobtanium",ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.ULTRARARE, 0xF17E4A, MaterialDimension.NONE);
	
	public static final ItemMaterial clusterCoal = new ItemMaterial("clusterCoal", ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.EVERYWHERE, 0x373737);
	public static final ItemMaterial clusterLapis = new ItemMaterial("clusterLapis", ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.UNCOMMON, 0x183DC0);
	public static final ItemMaterial clusterRedstone = new ItemMaterial("clusterRedstone", ModCreativeTabs.plate, MaterialType.CLUSTER, MaterialRarity.COMMON, 0xB80505);
	
	// Plates
	public static final ItemMaterial plateAdamanite = new ItemMaterial("plateAdamanite",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xAE6082);
	public static final ItemMaterial plateAdamant = new ItemMaterial("plateAdamant",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xFFAE9C);
	public static final ItemMaterial plateAluminium = new ItemMaterial("plateAluminium",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0xA4A8AB);
	public static final ItemMaterial plateBlurite = new ItemMaterial("plateBlurite",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0x64868E);
	public static final ItemMaterial plateBrass = new ItemMaterial("plateBrass",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0x9A822C);
	public static final ItemMaterial plateBronze = new ItemMaterial("plateBronze",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xA56600);
	public static final ItemMaterial plateChromium = new ItemMaterial("plateChromium",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xFCFCFC);
	public static final ItemMaterial plateCobalt = new ItemMaterial("plateCobalt",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0x364664);
	public static final ItemMaterial plateCopper = new ItemMaterial("plateCopper",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.EVERYWHERE, 0xAA6011);
	public static final ItemMaterial plateDaeyalt = new ItemMaterial("plateDaeyalt",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xCDB6CD);
	public static final ItemMaterial plateElectrum = new ItemMaterial("plateElectrum",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xE1D45C);
	public static final ItemMaterial plateGold = new ItemMaterial("plateGold",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0xFFFF0B);
	public static final ItemMaterial plateGoloid = new ItemMaterial("plateGoloid",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xF7CF1E);
	public static final ItemMaterial plateInvar = new ItemMaterial("plateInvar",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0x88877C);
	public static final ItemMaterial plateIron = new ItemMaterial("plateIron",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.EVERYWHERE, 0xEFEFEF);
	public static final ItemMaterial plateLead = new ItemMaterial("plateLead",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0x353047);
	public static final ItemMaterial plateLunar = new ItemMaterial("plateLunar",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xDBEADB);
	public static final ItemMaterial plateMalagnite = new ItemMaterial("plateMalagnite",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.RARE, 0x762DC9);
	public static final ItemMaterial plateManganese = new ItemMaterial("plateManganese",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xB1A7A9);
	public static final ItemMaterial plateMithril = new ItemMaterial("plateMithril",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xCAD7D8);
	public static final ItemMaterial plateNickel = new ItemMaterial("plateNickel",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0x6F7671);
	...
	public static final ItemMaterial platePlatinum = new ItemMaterial("platePlatinum",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xCCCBC0);
	public static final ItemMaterial plateRhodium = new ItemMaterial("plateRhodium",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xDFDFDF);
	public static final ItemMaterial plateRubium = new ItemMaterial("plateRubium",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xCC6363);
	public static final ItemMaterial plateRunite = new ItemMaterial("plateRunite",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xABBAC3);
	public static final ItemMaterial plateSilicon = new ItemMaterial("plateSilicon", ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xC6C6C6);
	public static final ItemMaterial plateSilver = new ItemMaterial("plateSilver",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0xFFFFFF);
	public static final ItemMaterial plateSolder = new ItemMaterial("plateSolder",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0xD2CFD6);
	public static final ItemMaterial plateSteel = new ItemMaterial("plateSteel",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.AVERAGE, 0x8C8C8C);
	public static final ItemMaterial plateTin = new ItemMaterial("plateTin",ModCreativeTabs.item, MaterialType.PLATE, MaterialRarity.UNCOMMON, 0xD3C9CB);
	...
	public static void init() {
		...
		// Shards
		GameRegistry.registerItem(shardAmazonite, shardAmazonite.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardAmber, shardAmber.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardAmethyst, shardAmethyst.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardAquamarine, shardAquamarine.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardCarnelian, shardCarnelian.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardCitrine, shardCitrine.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardDiamond, shardDiamond.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardEmerald, shardEmerald.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardGarnet, shardGarnet.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardJade, shardJade.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardKunzite, shardKunzite.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardNetherQuartz, shardNetherQuartz.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardOnyx, shardOnyx.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardOpal, shardOpal.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardQuartz, shardQuartz.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardRuby, shardRuby.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardSapphire, shardSapphire.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardTopaz, shardTopaz.getTrueUnlocalizedName());
		
		GameRegistry.registerItem(shardFyrestone, shardFyrestone.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardVoidiumRadioactiveFocused, shardVoidiumRadioactiveFocused.getTrueUnlocalizedName());
		
		GameRegistry.registerItem(shardObsidian, shardObsidian.getTrueUnlocalizedName());
		
		GameRegistry.registerItem(shardUnobtanium, shardUnobtanium.getTrueUnlocalizedName());
		GameRegistry.registerItem(shardTrytementium, shardTrytementium.getTrueUnlocalizedName());
