	...
	public static void init() {
		...
		if(ConfigurationHandler.disableCakeVanilla==true) {
			...
			while(cake.hasNext()) {
				...
				if(stack!=null&&stack.getItem()==Items.cake) cake.remove();
			};
		}
		if(ConfigurationHandler.disableBreadVanilla==true) {
			...
			while(bread.hasNext()) {
				...
				if(stack!=null&&stack.getItem()==Items.bread) bread.remove();
			};
		}
		if(ConfigurationHandler.disablePieVanilla==true) {
			...
			while(pie.hasNext()) {
				...
				if(stack!=null&&stack.getItem()==Items.pumpkin_pie) pie.remove();
			};
		}
