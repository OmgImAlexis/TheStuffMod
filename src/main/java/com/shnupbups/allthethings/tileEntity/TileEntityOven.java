...
public class TileEntityOven extends TileEntity implements ISidedInventory,IEnergyHandler,ICraftingMachine {
	...
	public boolean canOperate() {
		...
		if(inventory[9]==null&&inventory[10]==null) {
			return true;
		}
		if((inventory[9]!=null&&!inventory[9].isItemEqual(OvenRecipes.getInstance().findMatchingOutput(this,worldObj)))) {
			return false;
		}
		if((inventory[9]!=null&&inventory[9].stackSize+OvenRecipes.getInstance().findMatchingOutput(this,worldObj).stackSize>inventory[9].getMaxStackSize())) {
			return false;
		}
		if(inventory[9]!=null) {
