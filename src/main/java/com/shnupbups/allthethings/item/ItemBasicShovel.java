...
public class ItemBasicShovel extends ItemSpade {
	...
	public ItemBasicShovel(ToolMaterial material,String name,int colour) {
		super(material);
		this.maxStackSize=1;
	...
	public ItemBasicShovel(ToolMaterial material,String name,int colour,CreativeTabs tab) {
	...
	public void registerIcons(IIconRegister register) {
		icon=new IIcon[2];
		icon[0]=register.registerIcon(Reference.MOD_ID+":shovelHandle");
		icon[1]=register.registerIcon(Reference.MOD_ID+":shovel");
	}
}