...
public class ItemBlockPearSlab extends ItemBlock{
    ...
    public ItemBlockPearSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.pearSlab;
	    this.field_150947_d = ModBlocks.pearDoubleSlab;
