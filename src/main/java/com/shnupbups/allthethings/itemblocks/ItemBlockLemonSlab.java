...
public class ItemBlockLemonSlab extends ItemBlock{
    ...
    public ItemBlockLemonSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.lemonSlab;
	    this.field_150947_d = ModBlocks.lemonDoubleSlab;
