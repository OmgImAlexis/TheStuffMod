...
public class ItemBlockRubberSlab extends ItemBlock{
    ...
    public ItemBlockRubberSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.rubberSlab;
	    this.field_150947_d = ModBlocks.rubberDoubleSlab;
