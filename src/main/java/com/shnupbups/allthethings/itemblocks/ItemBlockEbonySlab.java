...
public class ItemBlockEbonySlab extends ItemBlock{
    ...
    public ItemBlockEbonySlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.ebonySlab;
	    this.field_150947_d = ModBlocks.ebonyDoubleSlab;
