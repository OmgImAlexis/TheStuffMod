...
public class ItemBlockBananaSlab extends ItemBlock{
    ...
    public ItemBlockBananaSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.bananaSlab;
	    this.field_150947_d = ModBlocks.bananaDoubleSlab;
