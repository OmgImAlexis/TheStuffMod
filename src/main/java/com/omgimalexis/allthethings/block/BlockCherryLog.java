...
public class BlockCherryLog extends BlockRotatedPillar {	
	public BlockCherryLog(String name, Material material, CreativeTabs tab, int harvest, int hard) {
		super(material);
	...
	public BlockCherryLog(String name, Material material, CreativeTabs tab, int harvest, int hard, int opacity) {
		this(name, material, tab, harvest, hard);
		this.setLightOpacity(opacity);
	}
	
	public BlockCherryLog(String name, Material material, CreativeTabs tab, int harvest, int hard, float light) {
		this(name, material, tab, harvest, hard);
