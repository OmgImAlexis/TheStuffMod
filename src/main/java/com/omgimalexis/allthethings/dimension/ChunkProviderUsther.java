...
public class ChunkProviderUsther implements IChunkProvider
{
	...
	public List spawnableAnimalList;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                ...
                                {
                                    p_147424_3_[j3 += short1] = ModBlocks.moltenIron;
                                }
                                else
                                {
    ...
    public List getPossibleCreatures(EnumCreatureType p_73155_1_, int p_73155_2_, int p_73155_3_, int p_73155_4_)
    {
        ...
        return p_73155_1_ == EnumCreatureType.monster && this.scatteredFeatureGenerator.func_143030_a(p_73155_2_, p_73155_3_, p_73155_4_) ? this.scatteredFeatureGenerator.getScatteredFeatureSpawnList() : this.getSpawnableList(p_73155_1_);
    }

    private List getSpawnableList(EnumCreatureType p_73155_1_) {
		if(p_73155_1_ == EnumCreatureType.monster) return spawnableMonsterList;
		else if(p_73155_1_ == EnumCreatureType.creature) return spawnableAnimalList;
		else return null;
	}
