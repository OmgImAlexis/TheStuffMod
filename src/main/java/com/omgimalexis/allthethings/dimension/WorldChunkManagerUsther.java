...
import static com.omgimalexis.allthethings.init.ModBiomes.usthericPlains;
...
public class WorldChunkManagerUsther extends WorldChunkManager{
	
	public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(usthericPlains));
    ...
    public WorldChunkManagerUsther(long p_i1975_1_, WorldType p_i1975_3_)
    {
        this();
    ...
    public WorldChunkManagerUsther(World p_i1976_1_)
    {
