...
public class ItemBlockMapleSlab extends ItemBlock{
    ...
    public ItemBlockMapleSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.mapleSlab;
	    this.field_150947_d = ModBlocks.mapleDoubleSlab;
