...
public class ItemBlockCherrySlab extends ItemBlock{
    ...
    public ItemBlockCherrySlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.cherrySlab;
	    this.field_150947_d = ModBlocks.cherryDoubleSlab;
