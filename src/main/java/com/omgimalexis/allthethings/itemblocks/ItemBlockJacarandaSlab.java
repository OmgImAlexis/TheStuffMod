...
public class ItemBlockJacarandaSlab extends ItemBlock{
    ...
    public ItemBlockJacarandaSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.jacarandaSlab;
	    this.field_150947_d = ModBlocks.jacarandaDoubleSlab;
