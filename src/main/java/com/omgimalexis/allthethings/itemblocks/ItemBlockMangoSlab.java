...
public class ItemBlockMangoSlab extends ItemBlock{
    ...
    public ItemBlockMangoSlab(Block p_i45355_1_)
    {
	    super(p_i45355_1_);
	    this.field_150949_c = ModBlocks.mangoSlab;
	    this.field_150947_d = ModBlocks.mangoDoubleSlab;
