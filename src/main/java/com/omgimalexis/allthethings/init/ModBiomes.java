...
public class ModBiomes {
	...
	public static final BiomeGenBase rubberPlains = new BiomeRubberPlains(41, "Rubber-Oak Plains", 0x89FFF1);
	
	public static void init() {
		BiomeManager.warmBiomes.add(new BiomeEntry(cherryForest, 10));
		BiomeManager.warmBiomes.add(new BiomeEntry(rubberPlains, 10));
	}
}
