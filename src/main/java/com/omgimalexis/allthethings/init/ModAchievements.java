...
public class ModAchievements {
	...
	public static final Achievement jeweller = new Achievement("jeweller", "jeweller", 2, 2, ModRings.ring, null).initIndependentStat();
	public static final Achievement pyromaniac = new Achievement("pyromaniac", "pyromaniac", 0, 2, ModRings.fyrestoneRing, jeweller);
	public static final Achievement steveAlmighty = new Achievement("steveAlmighty", "steveAlmighty", 2, 0, ModRings.voidiumRing, jeweller).setSpecial();
	...
	public static final Achievement marry = new Achievement("marry", "marry", 4, 2, ModRings.diamondRing, jeweller);
