package com.omgimalexis.allthethings.gui;
...
public class GuiCrusher extends GuiContainer{
	...
	public GuiCrusher(InventoryPlayer invPlayer, TileEntityCrusher tile) {
		super(new ContainerCrusher(invPlayer.player, tile.getWorldObj(), tile.xCoord, tile.yCoord, tile.zCoord));
		this.tileentity = (TileEntityCrusher) tile.getWorldObj().getTileEntity(tile.getMasterX(), tile.getMasterY(), tile.getMasterZ());
	...
	protected void drawGuiContainerForegroundLayer(int x, int y){
		...
		this.fontRendererObj.drawString(tileentity.getMasterX()+","+tileentity.getMasterY()+","+tileentity.getMasterZ(), this.xSize- 100, this.ySize-100, 4210752);
