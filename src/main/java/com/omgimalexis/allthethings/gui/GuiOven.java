...
public class GuiOven extends GuiContainer{
	...
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(Reference.MOD_ID + ":textures/gui/oven.png");
	private TileEntityOven tileentity;

	public GuiOven(InventoryPlayer invPlayer, TileEntityOven tile) {
		super(new ContainerOven(invPlayer.player, tile.getWorldObj(), tile.xCoord, tile.yCoord, tile.zCoord));
